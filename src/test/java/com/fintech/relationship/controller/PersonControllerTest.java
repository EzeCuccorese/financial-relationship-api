...
public class PersonControllerTest {
    ...
    void getStatsTest() {
        final PersonController personController = new PersonController(personService);
        final List<com.fintech.relationship.model.PeopleStats> stats = List.of(new com.fintech.relationship.model.PeopleStats("Argentina", 100));
        Mockito.when(personService.getPercentageByCountry()).thenReturn(stats);

        final ResponseEntity<List<com.fintech.relationship.model.PeopleStats>> actualResponse = personController.getStats();
